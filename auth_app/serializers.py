...
class AdminSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ("id", "username", "password", "is_product_admin", "is_order_admin", "is_sales_admin", "email", "phone_number", "first_name", "last_name", "gender", "address","image","user_registered_at")
